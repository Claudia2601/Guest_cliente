  ...
  //Agregar el  telfono del usuario
   ...
   public getCodigo(idx) {
    ...
    //insertar registro de tarjeta
        public agregarTarjeta(idUsuario,numTarjeta,anioExp,mesExp,cvc) {
            return new Promise((resolve, reject) => {
              this.afs
                .collection("tarjetas")
                .add({
          ...
          public getTarjetasUser(idx) {
            ...
            //Cambiar estatus de la tarjeta a eliminado
             ...
             //Cambiar estatus de la tarjeta a ACTIVA
              public updateTarjetaActiva(idx,tarjetaAnterior) {
                ...
                return new Promise((resolve, reject) => {
                  this.afs
                    ...
                    .then(reserva => {
                      console.log("Reservación actualizada: ", JSON.stringify(reserva));
                      resolve({ success: true });
                      //console.log('llego a provider la tarjeta anterior comparacion',tarjetaAnterior);
                      if (tarjetaAnterior != null) {
                        this.updateTarjetaVolverInactiva(tarjetaAnterior);
                      }
                    })
                    .catch(err => {
                      reject(err);
              ...
              //Volver inactiva cuando se cambia a otra tarjeta
               public updateTarjetaVolverInactiva(tarjetaAnterior) {
                 return new Promise((resolve, reject) => {
                   this.afs
                     .collection("tarjetas")
                     .doc(tarjetaAnterior)
